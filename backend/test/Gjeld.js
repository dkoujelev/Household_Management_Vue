...
describe('Gjeld',() => {
  ...
  beforeEach(() => {
    ...
    return clearDB()     // Vi må først nullstille testbasen
      .then((response) => {
        ...
        return axios.post('http://localhost:9100/rest/gjeld', testgjeld2);
      }).then(response => {
  ...
  it('Hent all gjeld som bruker skylder andre', () => {
    return axios.get('http://localhost:9100/rest/gjeldBrukerErSkyldig/1')
      .then(response => {
  ...
  it('Hent all gjeld som bruker skyldes av andre', () => {
    return axios.get('http://localhost:9100/rest/gjeldBrukerKreverInn/2')
      .then(response => {
        expect(response.data.length).to.equal(1);
        expect(response.data[0].sum).to.equal(200);
  ...
  it('Sett gjeld som betalt', () => {
    ...
    return axios.post('http://localhost:9100/rest/settGjeldSomBetalt/1')
      .then(response => {
